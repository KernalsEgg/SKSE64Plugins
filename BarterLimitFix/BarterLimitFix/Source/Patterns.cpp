	...
	namespace Events
	{
		bool GetCount1()
		{
			return Relocation::AddressLibrary::MatchPattern(
				...
				0x41ui8, 0x0Fui8, 0xB7ui8, 0x54ui8, 0x24ui8, static_cast<std::int8_t>(offsetof(Skyrim::InventoryEntryData, itemCountDelta)) // movzx edx, word ptr [r12 + 10]
			);
		}
		...
		bool GetCount3()
		{
			return Relocation::AddressLibrary::MatchPattern(
				...
				0x41ui8, 0x0Fui8, 0xB7ui8, 0x55ui8, static_cast<std::int8_t>(offsetof(Skyrim::InventoryEntryData, itemCountDelta)) // movzx edx, word ptr [r13 + 10]
			);
		}
		...
		bool GetCount4()
		{
			return Relocation::AddressLibrary::MatchPattern(
				...
				0x41ui8, 0x0Fui8, 0xB7ui8, 0x57ui8, static_cast<std::int8_t>(offsetof(Skyrim::InventoryEntryData, itemCountDelta)) // movzx edx, word ptr [r15 + 10]
			);
		}
