...
namespace LogInventoryItemRotation::Addresses
{
	namespace IMenu
	{
		...
		/// <summary>1.5.97.0: SkyrimSE.exe + 0x856EC0, 1.6.318.0: SkyrimSE.exe + 0x8B80D0</summary>
		inline const std::uintptr_t StopMouseRotation{ Relocation::AddressLibrary::GetSingleton().GetAddress(50107, 51770) }; // IMenu::StopMouseRotation
	}
}
