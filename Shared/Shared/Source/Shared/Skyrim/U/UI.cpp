...
namespace Skyrim
{
	...
	{
		auto* function{ reinterpret_cast<decltype(UI::PlaySound)*>(
			Addresses::UI::PlaySound()) };
	...
	{
		auto* function{ reinterpret_cast<decltype(UI::ShowNotification)*>(
			Addresses::UI::ShowNotification()) };
	...
	bool UI::IsMenuOpen(const BSFixedString& menuName) const
	{
		auto* function{ reinterpret_cast<
			Utility::TypeTraits::MakeFunctionPointer<decltype(&UI::IsMenuOpen)>::type>(
			Addresses::UI::IsMenuOpen()) };
