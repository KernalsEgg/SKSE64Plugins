...
namespace Skyrim
{
	...
	public:
		...
		virtual void Cast(SpellItem* spell, bool noHitEffectArt, Actor* target, float effectiveness, bool effectivenessRequiresHostility, float magnitudeOverride, Actor* cause); // 1
