...
namespace Skyrim
{
	namespace Addresses
	{
		namespace AbsorbEffect
		{
			...
			inline std::uintptr_t VirtualFunctionTable()
			{
		...
		namespace ActiveEffectFactory
		{
			...
			inline std::uintptr_t CheckTargetFunctions()
			{
			...
			inline std::uintptr_t InstantiateFunctions()
			{
		...
		namespace Actor
		{
			...
			inline std::uintptr_t AdjustHealthDamageToDifficulty()
			{
			...
			inline std::uintptr_t CanBeKilledBy()
			{
			...
			inline std::uintptr_t GetActorValueModifier()
			{
			...
			inline std::uintptr_t GetArmorRating()
			{
			...
			inline std::uintptr_t GetControllingActor()
			{
			...
			inline std::uintptr_t GetLineOfSightLocation()
			{
			...
			inline std::uintptr_t GetSoulLevel()
			{
			...
			inline std::uintptr_t GetWeaponDamage()
			{
			...
			inline std::uintptr_t HandleActorValueModified()
			{
			...
			inline std::uintptr_t IsActorInLineOfSight()
			{
			...
			inline std::uintptr_t IsPositionInLineOfSight()
			{
			...
			inline std::uintptr_t IsReferenceInLineOfSight()
			{
			...
			inline std::uintptr_t ModifyActorValue()
			{
			...
			inline std::uintptr_t RemoveActorValueModifiers()
			{
			...
			inline std::uintptr_t RemoveBasePerks()
			{
			...
			inline std::uintptr_t SetSelectedSpell()
			{
		...
		namespace ActorEquipManager
		{
			...
			inline std::uintptr_t EquipItem()
			{
			...
			inline std::uintptr_t Singleton()
			{
			...
			inline std::uintptr_t UnequipItem()
			{
		...
		namespace ActorValueInfo
		{
			...
			inline std::uintptr_t GetSingleton()
			{
		...
		namespace ActorValueOwner
		{
			...
			inline std::uintptr_t GetDualCastingEffectiveness()
			{
		...
		namespace BGSCreatedObjectManager
		{
			...
			inline std::uintptr_t DecrementReference()
			{
		...
		namespace BGSEntryPoint
		{
			...
			inline std::uintptr_t EntryPoints()
			{
			...
			inline std::uintptr_t HandleEntryPoint()
			{
		...
		namespace BGSEntryPointFunction
		{
			...
			inline std::uintptr_t EntryPointFunctionTypeArgumentCount()
			{
			...
			inline std::uintptr_t ExecuteFunction()
			{
		...
		namespace BGSImpactDataSet
		{
			...
			inline std::uintptr_t GetImpactData()
			{
		...
		namespace BGSImpactManager
		{
			...
			inline std::uintptr_t PlaySound()
			{
		...
		namespace BGSMaterialType
		{
			...
			inline std::uintptr_t GetMaterialTypeFromMaterialID()
			{
		...
		namespace BGSPerk
		{
			...
			inline std::uintptr_t ApplyPerk()
			{
		...
		namespace BGSSaveGameBuffer
		{
			...
			inline std::uintptr_t SaveFormID()
			{
		...
		namespace bhkNiCollisionObject
		{
			...
			inline std::uintptr_t GetRigidBody()
			{
		...
		namespace bhkWorld
		{
			...
			inline std::uintptr_t ScaleInverse()
			{
		...
		namespace BSAudioManager
		{
			...
			inline std::uintptr_t GetSoundHandleFromName()
			{
		...
		namespace BSFixedString
		{
			...
			inline std::uintptr_t Initialize()
			{
		...
		namespace BSPointerHandleManagerInterface
		{
			...
			inline std::uintptr_t GetHandle()
			{
			...
			inline std::uintptr_t GetSmartPointer()
			{
		...
		namespace BSReadWriteLock
		{
			...
			inline std::uintptr_t ReadUnlock()
			{
			...
			inline std::uintptr_t WriteLock()
			{
			...
			inline std::uintptr_t WriteUnlock()
			{
		...
		namespace Console
		{
			...
			inline std::uintptr_t SelectedReferenceHandle()
			{
		...
		namespace ConsoleLog
		{
			...
			inline std::uintptr_t PrintLine()
			{
		...
		namespace ContainerMenu
		{
			...
			inline std::uintptr_t TargetReferenceHandle()
			{
		...
		namespace EffectArchetypes
		{
			...
			inline std::uintptr_t Archetypes()
			{
		...
		namespace EffectItem
		{
			...
			inline std::uintptr_t ResetCost()
			{
			...
			inline std::uintptr_t SetConditions()
			{
		...
		namespace EnchantmentItem
		{
			...
			inline std::uintptr_t ModifyPower()
			{
		...
		namespace ExtraDataList
		{
			...
			inline std::uintptr_t IsQuestItem()
			{
			...
			inline std::uintptr_t SetLockList()
			{
		...
		namespace GameSettingCollection
		{
			...
			inline std::uintptr_t GetSetting()
			{
			...
			inline std::uintptr_t InitializeCollection()
			{
		...
		namespace GFxValue
		{
			namespace ObjectInterface
			{
				...
				inline std::uintptr_t AttachMovie()
				{
				...
				inline std::uintptr_t DeleteMember()
				{
				...
				inline std::uintptr_t GetArraySize()
				{
				...
				inline std::uintptr_t GetDisplayInformation()
				{
				...
				inline std::uintptr_t GetElement()
				{
				...
				inline std::uintptr_t GetMember()
				{
				...
				inline std::uintptr_t GotoAndPlay()
				{
				...
				inline std::uintptr_t HasMember()
				{
				...
				inline std::uintptr_t ObjectAddReference()
				{
				...
				inline std::uintptr_t ObjectRelease()
				{
				...
				inline std::uintptr_t RemoveElements()
				{
				...
				inline std::uintptr_t SetArraySize()
				{
				...
				inline std::uintptr_t SetDisplayInformation()
				{
				...
				inline std::uintptr_t SetElement()
				{
				...
				inline std::uintptr_t SetMember()
				{
		...
		namespace GMemory
		{
			...
			inline std::uintptr_t GlobalHeap()
			{
		...
		namespace GString
		{
			...
			inline std::uintptr_t Constructor()
			{
		...
		namespace hkReferencedObject
		{
			...
			inline std::uintptr_t AddReference()
			{
			...
			inline std::uintptr_t RemoveReference()
			{
		...
		namespace IFormFactory
		{
			...
			inline std::uintptr_t GetFormFactory()
			{
		...
		namespace InventoryEntryData
		{
			...
			inline std::uintptr_t IsOwnedBy()
			{
		...
		namespace ItemList
		{
			...
			inline std::uintptr_t GetSelectedItem()
			{
		...
		namespace MagicItem
		{
			...
			inline std::uintptr_t GetCostliestEffect()
			{
		...
		namespace Main
		{
			...
			inline std::uintptr_t FrameCount()
			{
		...
		namespace MemoryManager
		{
			...
			inline std::uintptr_t Deallocate()
			{
			...
			inline std::uintptr_t GetThreadScrapHeap()
			{
			...
			inline std::uintptr_t Reallocate()
			{
		...
		namespace NiAVObject
		{
			...
			inline std::uintptr_t GetBoneFromName()
			{
			...
			inline std::uintptr_t GetCollisionObject()
			{
		...
		namespace NiBooleanExtraData
		{
			...
			inline std::uintptr_t CreateObject()
			{
		...
		namespace NiMatrix33
		{
			...
			inline std::uintptr_t EulerAnglesToRotationMatrixXYZ()
			{
			...
			inline std::uintptr_t EulerAnglesToRotationMatrixZXY()
			{
			...
			inline std::uintptr_t RotationMatrixToEulerAnglesXYZ()
			{
			...
			inline std::uintptr_t RotationMatrixToEulerAnglesZXY()
			{
		...
		namespace NiObjectNET
		{
			...
			inline std::uintptr_t AddExtraData()
			{
			...
			inline std::uintptr_t AddNamedExtraData()
			{
			...
			inline std::uintptr_t DeleteExtraDataAt()
			{
			...
			inline std::uintptr_t GetExtraData()
			{
			...
			inline std::uintptr_t InsertExtraData()
			{
			...
			inline std::uintptr_t RemoveAllExtraData()
			{
			...
			inline std::uintptr_t RemoveExtraData()
			{
			...
			inline std::uintptr_t RemoveExtraDataAt()
			{
		...
		namespace PlayerCharacter
		{
			...
			inline std::uintptr_t GetDifficultyMultiplier()
			{
		...
		namespace PoisonedWeapon
		{
			...
			inline std::uintptr_t GetEventSource()
			{
		...
		namespace Precipitation
		{
			...
			inline std::uintptr_t RainDirection()
			{
		...
		namespace Script
		{
			...
			inline std::uintptr_t ClearCachedValues()
			{
			...
			inline std::uintptr_t CompileAndRun()
			{
			...
			inline std::uintptr_t ParseParameters()
			{
			...
			inline std::uintptr_t SetCommand()
			{
		...
		namespace ScriptCompiler
		{
			...
			inline std::uintptr_t GetFunctionDefinition()
			{
		...
		namespace TaskQueueInterface
		{
			...
			inline std::uintptr_t QueueScriptFunctionCall()
			{
			...
			inline std::uintptr_t ShouldQueueTask()
			{
		...
		namespace TES
		{
			...
			inline std::uintptr_t GetLandColor()
			{
			...
			inline std::uintptr_t GetMaterialID()
			{
		...
		namespace TESBoundObject
		{
			...
			inline std::uintptr_t GetWeight()
			{
		...
		namespace TESDataHandler
		{
			...
			inline std::uintptr_t EnumerateReferencesCloseToPoint()
			{
			...
			inline std::uintptr_t EnumerateReferencesCloseToReference()
			{
		...
		namespace TESForm
		{
			...
			inline std::uintptr_t GetEnchantment()
			{
			...
			inline std::uintptr_t GetFormFromEditorID()
			{
			...
			inline std::uintptr_t GetFormName()
			{
			...
			inline std::uintptr_t GetMaximumCharge()
			{
			...
			inline std::uintptr_t SetTemporary()
			{
		...
		namespace TESObjectCELL
		{
			...
			inline std::uintptr_t CreateTemporaryEffectParticle()
			{
			...
			inline std::uintptr_t GetHavokWorld()
			{
		...
		namespace TESObjectREFR
		{
			...
			inline std::uintptr_t GetInventoryChanges()
			{
			...
			inline std::uintptr_t GetReferenceFrom3D()
			{
			...
			inline std::uintptr_t GetReferenceName()
			{
			...
			inline std::uintptr_t IsCrimeToActivate()
			{
		...
		namespace TESObjectWEAP
		{
			...
			inline std::uintptr_t UnarmedWeapon()
			{
		...
		namespace TESSoulGem
		{
			...
			inline std::uintptr_t GetSoulLevelValue()
			{
		...
		namespace UI
		{
			...
			inline std::uintptr_t IsMenuOpen()
			{
			...
			inline std::uintptr_t ShowMessageBox()
			{
			...
			inline std::uintptr_t ShowNotification()
			{
		...
		namespace UIMessageQueue
		{
			...
			inline std::uintptr_t AddInventoryUpdateMessage()
			{
			...
			inline std::uintptr_t AddMessage()
			{
		...
		namespace VATS
		{
			...
			inline std::uintptr_t GetPlayerUpdateMultiplier()
			{
			...
			inline std::uintptr_t SetMagicTimeSlowdown()
			{
		...
		inline std::uintptr_t ThreadLocalStorageIndex()
		{
