...
namespace Skyrim
{
	...
	public:
		...
		BSTArray<NiPointer<BSTempEffect>> magicTemporaryEffects;         // 108
		mutable BSSpinLock                magicTemporaryEffectsLock;     // 120
	...
	static_assert(offsetof(ProcessLists, magicTemporaryEffects) == 0x108);
	static_assert(offsetof(ProcessLists, magicTemporaryEffectsLock) == 0x120);
