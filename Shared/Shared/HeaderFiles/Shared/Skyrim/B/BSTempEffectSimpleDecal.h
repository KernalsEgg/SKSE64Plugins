...
namespace Skyrim
{
	...
	public:
		...
		BGSTextureSet* textureSet1;    // 58
		BGSTextureSet* textureSet2;    // 60
	...
	static_assert(offsetof(BSTempEffectSimpleDecal, textureSet1) == 0x58);
	static_assert(offsetof(BSTempEffectSimpleDecal, textureSet2) == 0x60);
