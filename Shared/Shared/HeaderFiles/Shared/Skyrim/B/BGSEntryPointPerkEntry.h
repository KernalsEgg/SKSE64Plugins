...
namespace Skyrim
{
	...
	public:
		...
		virtual PerkEntryFunction GetFunction() const override;                                                    // 1
		...
		Utility::Enumeration<BGSPerkEntry::PerkEntryFunction, std::uint8_t> perkEntryFunction;      // 11
	...
	static_assert(offsetof(BGSEntryPointPerkEntry, perkEntryFunction) == 0x11);
