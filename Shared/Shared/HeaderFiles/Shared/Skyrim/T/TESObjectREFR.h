...
namespace Skyrim
{
	...
	public:
		...
		virtual ObjectReferenceHandle             RemoveItem(TESBoundObject* item, std::uint32_t itemCount, Utility::Enumeration<RemoveItemReason, std::uint32_t> reason, ExtraDataList* extraDataList, TESObjectREFR* moveToReference, const NiPoint3* position, const NiPoint3* rotation); // 56
