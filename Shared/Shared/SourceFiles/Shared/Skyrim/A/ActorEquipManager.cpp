...
namespace Skyrim
{
	...
	{
		auto* function{ reinterpret_cast<Utility::TypeTraits::MakeFunctionPointer<decltype(&ActorEquipManager::EquipItem)>::type>(Addresses::ActorEquipManager::EquipItem) };
	...
	{
		auto* function{ reinterpret_cast<Utility::TypeTraits::MakeFunctionPointer<decltype(&ActorEquipManager::UnequipItem)>::type>(Addresses::ActorEquipManager::UnequipItem) };
