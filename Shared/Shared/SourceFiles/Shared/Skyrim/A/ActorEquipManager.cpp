...
namespace Skyrim
{
	...
	{
		auto* function{ reinterpret_cast<Utility::MemberFunctionPointer<decltype(&ActorEquipManager::EquipItem)>::type>(Addresses::ActorEquipManager::EquipItem) };
	...
	{
		auto* function{ reinterpret_cast<Utility::MemberFunctionPointer<decltype(&ActorEquipManager::UnequipItem)>::type>(Addresses::ActorEquipManager::UnequipItem) };
