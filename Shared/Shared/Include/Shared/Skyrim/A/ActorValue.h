...
namespace Skyrim
{
	enum class ActorValue : std::uint32_t
	{
		...
		kVoicePoints                        = 37,
		kVoiceRate                          = 38,
		kDamageResistance                   = 39,
		kPoisonResistance                   = 40,
		kFireResistance                     = 41,
		kElectricResistance                 = 42,
		kFrostResistance                    = 43,
		kMagicResistance                    = 44,
		kDiseaseResistance                  = 45,
		...
		kAbsorbChance                       = 83,
		kBlindness                          = 84,
		kWeaponSpeedMultiplier              = 85,
		kShoutRecoveryMultiplier            = 86,
		kBowStaggerBonus                    = 87,
		kTelekinesis                        = 88,
		kFavorPointsBonus                   = 89,
		kLastBribedIntimidated              = 90,
		kLastFlattered                      = 91,
		kMovementNoiseMultiplier            = 92,
		...
		kLeftWeaponSpeedMultiplier          = 132,
		kDragonSouls                        = 133,
		kCombatHealthRegenerationMultiplier = 134,
		...
		kDragonRend                         = 153,
		kAttackDamageMultiplier             = 154,
		kHealRateMultiplier                 = 155,
		kMagickaRateMultiplier              = 156,
		kStaminaRateMultiplier              = 157,
		kWerewolfPerks                      = 158,
		kVampirePerks                       = 159,
		...
		kAIAttributes      = kAggression,
		kSkills            = kOneHanded,
		kDerivedAttributes = kHealth,
		kResistances       = kDamageResistance
	};
