...
namespace Skyrim
{
	...
	public:
		...
		virtual ObjectReferenceHandle RemoveBoundObject(TESBoundObject* boundObject, std::uint32_t boundObjectCount, Utility::Enumeration<ItemRemoveReason, std::uint32_t> reason, ExtraDataList* extraDataList, TESObjectREFR* moveToReference, const NiPoint3* position, const NiPoint3* rotation) override; // 56
