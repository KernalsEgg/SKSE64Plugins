...
namespace Skyrim
{
	...
	public:
		...
		virtual ObjectReferenceHandle RemoveBoundObject(TESBoundObject* boundObject, std::uint32_t boundObjectCount, Utility::Enumeration<TESObjectREFR::RemoveItemReason, std::uint32_t> reason, ExtraDataList* extraDataList, TESObjectREFR* moveToReference, const NiPoint3* position, const NiPoint3* rotation) override; // 56
		...
		MagicItem*                                        selectedSpells[Utility::Conversion::ToUnderlying(SlotType::kTotal)]; // 1C0, 1C8
