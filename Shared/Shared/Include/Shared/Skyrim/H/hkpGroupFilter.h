...
namespace Skyrim
{
	...
	public:
		...
		virtual bool IsCollisionEnabled(const hkpCollisionInput& input, const hkpCdBody& collisionDetectionBodyA, const hkpCdBody& collectionCollisionDetectionBodyB, const hkpShapeContainer& shapeContainerB, hkpShapeKey shapeKeyB) const override;                                                                            // 0
		virtual bool IsCollisionEnabled(const hkpCollisionInput& input, const hkpCdBody& collectionCollisionDetectionBodyA, const hkpCdBody& collectionCollisionDetectionBodyB, const hkpShapeContainer& shapeContainerA, const hkpShapeContainer& shapeContainerB, hkpShapeKey shapeKeyA, hkpShapeKey shapeKeyB) const override; // 1

		// Override (hkpRayShapeCollectionFilter)
		virtual bool IsCollisionEnabled(const hkpShapeRayCastInput& inputA, const hkpShapeContainer& shapeContainerB, hkpShapeKey shapeKeyB) const override; // 0
