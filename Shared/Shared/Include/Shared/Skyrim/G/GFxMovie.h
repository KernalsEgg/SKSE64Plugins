...
namespace Skyrim
{
	...
	public:
		...
		virtual bool          SetVariable(const char* pathToVariable, const GFxValue& value, Utility::Enumeration<SetVariableType, std::uint32_t> setVariableType = SetVariableType::kSticky)                                                                                                           = 0; // 10
		virtual bool          GetVariable(GFxValue* value, const char* pathToVariable) const                                                                                                                                                                                                            = 0; // 11
		virtual bool          SetVariableArray(Utility::Enumeration<SetArrayType, std::uint32_t> setArrayType, const char* pathToVariable, std::uint32_t index, const void* data, std::uint32_t count, Utility::Enumeration<SetVariableType, std::uint32_t> setVariableType = SetVariableType::kSticky) = 0; // 12
		virtual bool          SetVariableArraySize(const char* pathToVariable, std::uint32_t count, Utility::Enumeration<SetVariableType, std::uint32_t> setVariableType = SetVariableType::kSticky)                                                                                                    = 0; // 13
		virtual std::uint32_t GetVariableArraySize(const char* pathToVariable)                                                                                                                                                                                                                          = 0; // 14
		virtual bool          GetVariableArray(Utility::Enumeration<SetArrayType, std::uint32_t> setArrayType, const char* pathToVariable, std::uint32_t index, void* data, std::uint32_t count)                                                                                                        = 0; // 15
		...
		// Member functions
		bool   SetVariable(const char* pathToVariable, const char* value, Utility::Enumeration<SetVariableType, std::uint32_t> setVariableType = SetVariableType::kSticky);
		bool   SetVariable(const char* pathToVariable, const wchar_t* value, Utility::Enumeration<SetVariableType, std::uint32_t> setVariableType = SetVariableType::kSticky);
		bool   SetVariableDouble(const char* pathToVariable, double value, Utility::Enumeration<SetVariableType, std::uint32_t> setVariableType = SetVariableType::kSticky);
		double GetVariableDouble(const char* pathToVariable) const;
		bool   SetVariableArray(const char* pathToVariable, std::uint32_t index, const GFxValue* data, std::uint32_t count, Utility::Enumeration<SetVariableType, std::uint32_t> setVariableType = SetVariableType::kSticky);
