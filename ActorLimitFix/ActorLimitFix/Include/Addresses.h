...
namespace ActorLimitFix::Addresses
{
	...
	namespace ReplaceStaticArray
	{
		...
		inline const std::uintptr_t GetArrayCapacityAdd{ Relocation::AddressLibrary::GetSingleton().GetAddress(41450) + 0x70 };

		/// <summary>1.5.97.0: SkyrimSE.exe + 0x6E1010 + 0x1BD (40427), 1.6.318.0: SkyrimSE.exe + 0x709CF0</summary>
		inline const std::uintptr_t GetArrayCapacityCommentOnPlayerAction{ Relocation::AddressLibrary::GetSingleton().GetAddress(41442) + 0x1CC };

		/// <summary>1.5.97.0: SkyrimSE.exe + 0x6E18D0 + 0x31 (40435), 1.6.318.0: SkyrimSE.exe + 0x70A780</summary>
		inline const std::uintptr_t GetArrayCapacityFind{ Relocation::AddressLibrary::GetSingleton().GetAddress(41452) + 0x31 };

		/// <summary>1.6.318.0: SkyrimSE.exe + 0x6FF3B0</summary>
		inline const std::uintptr_t GetArrayCapacityFindInline{ Relocation::AddressLibrary::GetSingleton().GetAddress(41318) + 0x6E };

		/// <summary>1.5.97.0: SkyrimSE.exe + 0x6D2C40 + 0x22 (40277), 1.6.318.0: SkyrimSE.exe + 0x6FB160</summary>
		inline const std::uintptr_t GetArrayCapacityGetActors{ Relocation::AddressLibrary::GetSingleton().GetAddress(41286) + 0x22 };

		/// <summary>1.5.97.0: SkyrimSE.exe + 0x6E1740 + 0x61 (40434), 1.6.318.0: SkyrimSE.exe + 0x70A5F0</summary>
		inline const std::uintptr_t GetArrayAdd{ Relocation::AddressLibrary::GetSingleton().GetAddress(41450) + 0x61 };

		/// <summary>1.5.97.0: SkyrimSE.exe + 0x6E1010 + 0x1C1 (40427), 1.6.318.0: SkyrimSE.exe + 0x709CF0</summary>
		inline const std::uintptr_t GetArrayCommentOnPlayerAction{ Relocation::AddressLibrary::GetSingleton().GetAddress(41442) + 0x1D0 };

		/// <summary>1.5.97.0: SkyrimSE.exe + 0x6E18D0 + 0x21 (40435), 1.6.318.0: SkyrimSE.exe + 0x70A780</summary>
		inline const std::uintptr_t GetArrayFind{ Relocation::AddressLibrary::GetSingleton().GetAddress(41452) + 0x21 };

		/// <summary>1.6.318.0: SkyrimSE.exe + 0x6FF3B0</summary>
		inline const std::uintptr_t GetArrayFindInline{ Relocation::AddressLibrary::GetSingleton().GetAddress(41318) + 0x60 };

		/// <summary>1.5.97.0: SkyrimSE.exe + 0x6D2C40 + 0x26 (40277), 1.6.318.0: SkyrimSE.exe + 0x6FB160</summary>
		inline const std::uintptr_t GetArrayGetActors{ Relocation::AddressLibrary::GetSingleton().GetAddress(41286) + 0x26 };

		/// <summary>1.5.97.0: SkyrimSE.exe + 0x6E1740 + 0x41 (40434), 1.6.318.0: SkyrimSE.exe + 0x70A5F0</summary>
		inline const std::uintptr_t HasCapacityAdd{ Relocation::AddressLibrary::GetSingleton().GetAddress(41450) + 0x41 };
	}
}
