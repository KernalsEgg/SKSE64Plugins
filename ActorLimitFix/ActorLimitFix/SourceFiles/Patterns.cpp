...
namespace ActorLimitFix::Patterns
{
	...
	namespace ReplaceStaticArray
	{
		...
		{
			return Relocation::AddressLibrary::MatchPattern(
				Addresses::ReplaceStaticArray::GetStaticArrayCapacityErase, // 0x4
				0xB9ui8, 0x80ui32                                           // mov ecx, 80
			);
		}
		...
		{
			return Relocation::AddressLibrary::MatchPattern(
				Addresses::ReplaceStaticArray::GetStaticArrayErase,      // 0x7
		...
		bool HasCapacityInsert()
		{
			return Relocation::AddressLibrary::MatchPattern(
				...
				0x0Fui8, 0x83ui8, 0xEDui32                        // jnb ED
			);
		}
	}
}
